package test.java.etsisi.ems.trabajo3.banco;

import java.time.LocalDate;
import java.time.ZoneId;
import java.util.Date;
import junit.framework.TestCase;
import main.java.etsisi.ems.trabajo3.banco.Credito;
import main.java.etsisi.ems.trabajo3.banco.Cuenta;
import main.java.etsisi.ems.trabajo3.banco.datosBancarios;
import main.java.etsisi.ems.trabajo3.banco.infoTarjeta;
import main.java.etsisi.ems.trabajo3.banco.numerosTarjeta;
...
public class CreditoTest extends TestCase {
	...
	public void setUp() throws Exception {
        ...
        numerosTarjeta nt = new numerosTarjeta("1234567890123456",fechacaducidad,123);
        infoTarjeta it = new infoTarjeta("Fulano de Tal",1000.0);
        datosBancarios dt = new datosBancarios(1, "bbva");
		tarjeta = new Credito(nt, it, dt); // 1000€ de crédito, tarjeta mastercard
